...
{
    internal sealed class RulesClientOptionsPostConfigure : IPostConfigureOptions<RulesClientOptions>
    {
        public void PostConfigure(string? name, RulesClientOptions options)
        {
