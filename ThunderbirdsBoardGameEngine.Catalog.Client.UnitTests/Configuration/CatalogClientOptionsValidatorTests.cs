...
{
    public class CatalogClientOptionsValidatorTests
    {
        [Theory]
        ...
        public void Validate_WhenOptionsIsNull_ReturnsFailure()
        {
            ...
            // Assert
            AssertFailureContains(result, "CatalogClientOptions is required.");
        }
        ...
        private static CatalogClientOptionsValidator CreateValidator()
        {
            return new CatalogClientOptionsValidator();
        }
