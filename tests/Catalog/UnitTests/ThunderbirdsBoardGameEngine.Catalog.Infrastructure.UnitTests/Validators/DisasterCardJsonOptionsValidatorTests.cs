...
namespace ThunderbirdsBoardGameEngine.Catalog.Infrastructure.UnitTests.Validators
{
    public class DisasterCardJsonOptionsValidatorTests
    {
        ...
        public void Validate_NullOptions_ReturnsFailure()
        {
            ...
            Assert.Contains("DisasterCardJsonOptions is required.", result.Failures);
        }
        ...
        {
            // Arrange
            var options = new DisasterCardJsonOptions { FilePath = "" };
        ...
        private static DisasterCardJsonOptionsValidator CreateValidator(IFileSystem fileSystem)
        {
