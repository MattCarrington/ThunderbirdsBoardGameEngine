...
{
    public class RulesClientOptionsPostConfigureTests
    {
        [Theory]
        ...
        private static RulesClientOptionsPostConfigure CreatePostConfigure()
        {
            return new RulesClientOptionsPostConfigure();
        }
    }
}
