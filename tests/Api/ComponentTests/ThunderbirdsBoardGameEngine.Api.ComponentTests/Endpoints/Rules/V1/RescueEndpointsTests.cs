...
{
    public class RescueEndpointsTests : IClassFixture<ApiComponentWebApplicationFactory>
    {
        ...
        public RescueEndpointsTests(ApiComponentWebApplicationFactory factory)
        {
