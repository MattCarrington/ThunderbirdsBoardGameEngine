...
{
    public class CharacterCodeTests
    {
        [Fact]
        public void Constructor_WhenValidCode_CreatesInstance()
        {
            // Arrange
            var code = "valid-character-code";

            // Act
            var result = new CharacterCode(code);
        ...
        public void Constructor_WhenInvalidCardValues_ThrowsArgumentException(string code)
        {
            ...
            // Act & Assert
            Assert.ThrowsAny<ArgumentException>(() => new CharacterCode(code));
        }
    }
}
